...
$opt_name = 'ounce';  // YOU MUST CHANGE THIS.  DO NOT USE 'redux_demo' IN YOUR PROJECT!!!
...
$args = array(
	...
	'menu_title'                => esc_html__( 'Theme Options', 'ounce' ),

	// The text to appear on the page title.
	'page_title'                => esc_html__( 'Theme Options', 'ounce' ),
...
// -> START Header  option Fields
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Header', 'ounce' ),
		'id'               => 'header-options',
		...
		'fields'           => array(
			array(
				'id'       => 'favicon-upload',
				'type'     => 'media',
				'title'    => esc_html__( 'Upload Favicon', 'ounce' ),
				'subtitle' => esc_html__( 'Upload Your Favicon', 'Ounce' ),
				'default'  => array(
					'url'	=> get_template_directory_uri() . '/assets/img/favicon.ico'
				),
			),
			array(
				'id'       => 'apple-favicon-upload',
				'type'     => 'media',
				'title'    => esc_html__( 'Upload Apple Favicon', 'ounce' ),
				'subtitle' => esc_html__( 'Upload Your Aple Favicon', 'Ounce' ),
				'default'  => array(
			...
			array(
				'id'       => 'logo-upload',
				'type'     => 'media',
				'title'    => esc_html__( 'Upload Logo', 'ounce' ),
				'subtitle' => esc_html__( 'Upload Your Logo', 'Ounce' ),
				'default'  => array(
					'url'	=> get_template_directory_uri() . '/assets/img/logo.jpg'
				),
			),
			array(
				'id'       => 'logo-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Logo Text', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Logo Text', 'Ounce' ),
				'default'  => 'Convert to Ounce.',
			),
			array(
				'id'       => 'topbar-mail',
				'type'     => 'text',
				'title'    => esc_html__( 'Mail', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Email', 'Ounce' ),
				'default'  => 'example@gmail.com',
			),
			array(
				'id'       => 'topbar-phone',
				'type'     => 'text',
				'title'    => esc_html__( 'Phone', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Phone Number', 'Ounce' ),
				'default'  => '+(880) 1912 967 614',
			),
			array(
				'id'       => 'fbid',
				'type'     => 'text',
				'title'    => esc_html__( 'Facebook', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your facebook id', 'Ounce' ),
				'default'  => '#',
			),
			array(
				'id'       => 'twitterid',
				'type'     => 'text',
				'title'    => esc_html__( 'Twitter', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Twitter id', 'Ounce' ),
				'default'  => '#',
			),
			array(
				'id'       => 'instaid',
				'type'     => 'text',
				'title'    => esc_html__( 'Instagram', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Instagram id', 'Ounce' ),
				'default'  => '#',
			),
			array(
				'id'       => 'linkedinid',
				'type'     => 'text',
				'title'    => esc_html__( 'Linkedin', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Linkedin id', 'Ounce' ),
				'default'  => '#',
			),
...
// Start Footer option Fields
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer', 'ounce' ),
		'id'               => 'footer-options',
		'customizer_width' => '400px',
		'icon'             => 'el el-home',
		'fields'           => array(
			array(
				'id'       => 'copyright-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Copyright Text', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Copyright Text', 'Ounce' ),
				'default'  => 'Convert to Ounce',
			),
			array(
				'id'       => 'footer-right-text',
				'type'     => 'text',
				'title'    => esc_html__( 'Footer Text', 'ounce' ),
				'subtitle' => esc_html__( 'Set Your Footer Text', 'Ounce' ),
				'default'  => 'Convert to Ounce',
			),
